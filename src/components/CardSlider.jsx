...
const CardSlider = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 md:grid-cols-2 lg:grid-cols-2 gap-8 md:mx-8 mx-4">
      {projects.map((project) => (
        <Link key={project.id} to={`/projects/${project.id}`}>
          <div className="bg-[#8000ff] bg-opacity-[0.7] rounded-md hover:shadow-md hover:shadow-purple-700 cursor-pointer transform hover:scale-105">
            <img src={project.imageURL} alt={project.title} className="w-full h-80 object-cover mb-2 rounded-t" />
            <div className="p-4">
