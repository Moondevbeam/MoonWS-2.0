...
const Card = ({ imgSrc, cardTitle, onOpen }) => {
  return (
    <div className="card out phone mr3 pointer w5 bg-purple" style={{ border: "none", display: "grid", gridTemplateRows: "auto 1fr", transition: "box-shadow 0.3s" }} onClick={onOpen}>
